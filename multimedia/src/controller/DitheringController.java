...
import ditherDissolve.DitherDissolve;
 ...
 */
public class DitheringController implements Initializable {
    private File file;
    private File mFile;
    ...
    void do_floyed_action(ActionEvent event) throws IOException, InterruptedException {
        new ditherDissolve.Gui(String.valueOf(mFile));
        DitherDissolve mDitherDissolve=new DitherDissolve();
        Float alpha=Float.parseFloat(JOptionPane.showInputDialog(null,"enter Alpha :"));
        mDitherDissolve.readBMP(String.valueOf(file),String.valueOf(mFile),alpha);
    }
