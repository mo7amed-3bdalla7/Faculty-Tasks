...
import company.OrderedDithering;
 ...
 */
public class orderDith implements Initializable {
    ...
    void do_floyed_action(ActionEvent event) {
        OrderedDithering mDithering=new OrderedDithering();
        try {
            System.out.println("mmmm"+file.toString());
            File mFile=new File(mDithering.readBMP(file.toString()));
